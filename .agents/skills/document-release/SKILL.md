...
description: "Post-ship documentation update. After shipping a feature, updates README, domain docs, API docs, DB contract, context docs, and translation key references. Catches stale documentation automatically. Use after /ship to keep project docs accurate."
---
...
### 2. Domain Docs
If domain entities or business rules changed, update inline docs in the domain layer.

### 3. API Docs
If API surface changed, update route documentation and request/response examples.

### 4. DB Contract
If repository interface or SQL mode changed, update the database contract documentation.
